	...
	ctx.JSON(200, gin.H{
		"data": models.Customers{
			Customers: []models.Customer{
				{ID: 1,
					Email:       "teste@test.com.br",
					Name:        "Centro Eletrico",
					FantasyName: "Centro Eletrico",
					CPFCNPJ:     "123456789",
					IE:          "123456789",
					Phone:       "123456789",
					Website:     "teste.com.br",
				...
				{ID: 2,
					Email:       "teste@test.com.br",
					Name:        "Materiais de Construcao Castanhal",
					FantasyName: "Materiais de construcao",
					CPFCNPJ:     "123456789",
					IE:          "123456789",
					Phone:       "123456789",
					Website:     "teste.com.br",
				...
				},
				{
					ID:          3,
					Email:       "teste@test.com.br",
					Name:        "Germer Construcoes",
					FantasyName: "Germer LTDA",
					CPFCNPJ:     "123456789",
					IE:          "123456789",
					Phone:       "123456789",
					Website:     "teste.com.br",
